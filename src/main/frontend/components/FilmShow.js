...
const FilmShow = props => {
  ...
  if (!film) {
    ...
    reviewsList = film.reviews.map(review => {
    ...
    if (!average == 0) {
      displayedAverage = average.toFixed(1)
    } if (film.reviews.length == 0) {
      displayedAverage = "-"
    }

    let reviewsCount = film.reviews.length

    let reviewForm = <ReviewForm errors={formErrors} postNewReview={addReview} />
        ...
        <div className="center-column">
          <div className="movie-meta-data">
            ...
            <div className="score-section">
              ...
              <p>{reviewsCount} {reviewsCount == 1 ? "review" : "reviews"}</p>
            </div>
          </div>
